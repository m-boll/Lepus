...
def init(domain):
	...
	if CHAOS_KEY == "":
		print(r"  \__", colored("No Project Discovery Chaos API key configured", "red"))
		return []

	headers = {"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:88.0) Chrome/142.0", "Authorization": CHAOS_KEY}
	...
	try:
		...
		print(r"  \__ {0}: {1}".format(colored("Subdomains found", "cyan"), colored(len(PDCH), "yellow")))
		return PDCH
